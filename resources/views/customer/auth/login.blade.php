        ...
        <div class="account-content">
            <div class="login-wrapper">
                <div class="login-content">
                    <form id="login-form" action="{{ route('customer.loggedin')}}" method="POST">
                    @csrf
                        <div class="login-user-info">
                            ...
                            <div class="login-heading">
                                <h4>Sign In</h4>
                                <p>Access the Customer panel using your email and passcode.</p>
                            </div>
                            <div class="form-wrap">
                            ...
                            <div class="form-wrap form-wrap-checkbox">
                                ...
                                <div class="text-end">
                                    <a href="{{route('customer.register')}}" class="forgot-link">Register</a>
                                </div> 
                            </div>
                            <div class="form-wrap">
