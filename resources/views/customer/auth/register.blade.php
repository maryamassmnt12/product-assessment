...
<body class="account-page">
        ...
        <div class="account-content">
            <div class="login-wrapper">
                <div class="login-content">
                    <form id="register-form" method="POST" action="{{ route('customer.registration')}}">
                    @csrf
                        <div class="login-user-info">
                            ...
                            <div class="login-heading">
                                <h4>Register</h4>
                                <p>Register for Customer panel using your basic details.</p>
                            </div>
                            <div class="form-wrap">
                            ...
                            <div class="form-wrap form-wrap-checkbox">
                                ...
                                <div class="text-end">
                                    <a href="{{route('customer.login')}}" class="forgot-link">Login</a>
                                </div> 
                            </div>
                            <div class="form-wrap">
    ...
    <script src="{{asset('assets/js/jquery.min.js')}}"></script>  <!-- Add by Developer -->
